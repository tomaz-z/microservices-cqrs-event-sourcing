...
// WithProduct adds the product to the add params
func (o *AddParams) WithProduct(product *models.Product) *AddParams {
	o.SetProduct(product)
	return o
}

// SetProduct adds the product to the add params
func (o *AddParams) SetProduct(product *models.Product) {
	o.Product = product
}
