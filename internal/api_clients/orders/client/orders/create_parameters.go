...
// WithOrder adds the order to the create params
func (o *CreateParams) WithOrder(order *models.Order) *CreateParams {
	o.SetOrder(order)
	return o
}

// SetOrder adds the order to the create params
func (o *CreateParams) SetOrder(order *models.Order) {
	o.Order = order
}
